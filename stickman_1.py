...
class Game:
    def __init__(self):
        ...
        self.bg_1 = PhotoImage(file="C:\\Users\\ROSE THOMAS\\Desktop\\python class\\images\\bckgrd_1.gif")
        self.bg_2 = PhotoImage(file="C:\\Users\\ROSE THOMAS\\Desktop\\python class\\images\\bckgrd_2.gif")
        
        w = self.bg_1.width()
        h = self.bg_1.height()
        l=[1,0,1,0,1]
        for x in range(0, 5):
            for y in range(l[x], 5,2):
